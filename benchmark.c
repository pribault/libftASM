...
/*   Updated: 2018/02/16 16:42:31 by pribault         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		ft_old_swap(void *a, void *b, size_t size)
{
	size_t	i;
...
static void	test_ft_bzero_1(void)
{
...
static void	test_ft_memcpy_1(void)
{
	static char	a[ARRAY_SIZE];
...
static void	test_ft_memset_1(void)
{
	static char	a[ARRAY_SIZE];
...
static void	test_ft_puts_1(void)
{
	char	*s = STR1;
...
static void	test_ft_strcat_1(void)
{
...
static void	test_strcat_1(void)
{
	char	s[ARRAY_SIZE] = STR2;
...
static void	test_ft_strdup_1(void)
{
	free(ft_strdup(STR1));
}
...
static void	test_ft_strlen_1(void)
{
	int	ret = ft_strlen(STR1);
}
...
static void	test_ft_tolower_1(void)
{
	int	ret = ft_tolower('A');
}

static void	test_tolower_1(void)
{
	int	ret = tolower('A');
}

static void	test_ft_toupper_1(void)
{
	int	ret = ft_toupper('A');
}

static void	test_toupper_1(void)
{
	int ret = toupper('A');
}

static void	test_ft_isalnum_1(void)
{
	int	ret = ft_isalnum('A');
}

static void	test_isalnum_1(void)
{
	int	ret = isalnum('A');
}

static void	test_ft_isalpha_1(void)
{
...
static void	test_ft_isascii_1(void)
{
	int	ret = ft_isascii('A');
}

static void	test_isascii_1(void)
{
	int	ret = isascii('A');
}

static void	test_ft_isdigit_1(void)
{
	int	ret = ft_isdigit('A');
}

static void	test_isdigit_1(void)
{
	int	ret = isdigit('A');
}

static void	test_ft_isprint_1(void)
{
	int	ret = ft_isprint('A');
}

static void	test_isprint_1(void)
{
	int	ret = isprint('A');
}

static void	test_ft_cat_1(void)
{
	system("./ft_cat Makefile");
}

static void	test_cat_1(void)
{
	system("cat Makefile");
}
...
static void	test_ft_memcmp_1(void)
{
	...
	bzero(&b, ARRAY_SIZE);
	b[ARRAY_SIZE - 1] = 1;
	int	ret = ft_memcmp(&a, &b, ARRAY_SIZE);
}

static void	test_memcmp_1(void)
{
	char	a[ARRAY_SIZE];
	char	b[ARRAY_SIZE];
	...
	bzero(&b, ARRAY_SIZE);
	b[ARRAY_SIZE - 1] = 1;
	int	ret = memcmp(&a, &b, ARRAY_SIZE);
}

static void	test_ft_strcmp_1(void)
{
	int	ret = ft_strcmp(STR1, STR_SAD);
}

static void	test_strcmp_1(void)
{
	int	ret = strcmp(STR1, STR_SAD);
}

static void	test_ft_swap_1(void)
{
	char	a[ARRAY_SIZE];
	char	b[ARRAY_SIZE];
...
static void	test_old_swap_1(void)
{
	char	a[ARRAY_SIZE];
	char	b[ARRAY_SIZE];
...
static size_t	test_loop(t_func func, size_t seconds)
{
